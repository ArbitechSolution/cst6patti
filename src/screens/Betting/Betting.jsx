                ...
                <div class="profile-edit-wrapper">
                    <div class="row gy-5">
                        ...
                        <div class="col-xl-5 text-center">
                            <h2 class="section-header__title text-center" style={{ fontSize: "19px", textAlign: "center" }}>CHOOSE BETTING AMOUNT IN CST TOKEN</h2>
                                    ...
                                    <div class="row gy-3">
                                        <div class="main">
                                            ...
                                            <div class="form-group center">
                                                <label for="lname" class="form-label top">CST COIN</label>
                                        ...
                                        <div class="main">
                                            ...
                                            <div class="form-group center">
                                                <label class="form-label" for="about">CST COIN</label><br />
                                        ...
                                        <div class="col-md-6">
                                            <button class="cmn--btn active mt-3" onClick={() => Bet_Amount()}>{IsLoading}</button>
                                        </div>
                                        <div class="col-md-6">
                                            <button class="cmn--btn active mt-3" onClick={() => withdraw()} >{Withdrawbtn}</button>
                                        </div>
                        ...
                        <div class="col-xl-7">
                            <div class="section-header text-center">
                                <h2 class="section-header__title" style={{ fontSize: "19px" }}>IF YOU BET 100 CST TOKEN (MIN BET 1, MAX BET 40,000)
                                </h2>

                                <div class="table-responsive-md border" style={{ overflow: "auto", fontFamily: "Font Awesome 5 Free" }}>
                                    <table class="table">
                                        <thead>
                                            <tr className="textCaps" style={{ border: "2px solid white" }}>
