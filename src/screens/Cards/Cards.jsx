...
export default function Cards({
    ...
    const userInfo = async () => {
        try {
            ...
            if (acc === "No Wallet") {
                ...
                console.log("Wrong Newtwork please connect to test net");
    ...
    const card_withdraw = (id) => {
        ...
        change_Color.style.border = `10px solid #610b6e`
        ...
        div class="row gy-4 justify-content-center" >
...

                                {
                                    imgArray.map((items, index) => {
                                        ...
                                        return (<div class="col-lg-4 col-xl-2 col-md-6 col-sm-6" >
                                            <div class="game-item" >
                                                <div class="game-inner" >
                                                    <div class="game-item__thumb" >
                                                        ...
                                                        <div class="game-item__content" >
                                                            <h4 class="title"  style={{fontFamily: "Font Awesome 5 Free"}}> {
                                                                items.Cname} < /h4>
                                                                <
/div> <
                    /div>
        ...
        /div> {
                                                                            getId.length && < div class="section-header text-center padding-top" >
                                                                                <
                h2 class="section-header__title padding-top"
                                                                                    style={
                                                                                        {
                                                                                            paddingBottom: '30px'
                                                                                        }
                                                                                    } > WINNING CARD HISTORY < /h2> <
                div class="row justify-content-center" >
