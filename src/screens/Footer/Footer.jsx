    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-wrapper d-flex flex-wrap justify-content-center align-items-center text-center">
                ...
                <p class="copyright text-white" style={{fontFamily: "Font Awesome 5 Free"}}>© Copyright CSTSwap 2022 &nbsp;<a target="_blank" href="https://bscscan.com/address/0x10393D8a07621e7B7c48E36C41c72ceBC0A6b3D6#readContract"style={{color: '#fff' , fontweight: 'bold'}}>Smart Contract <i class="fa fa-hand-o-left" aria-hidden="true"></i></a></p>
            </div>
        </div>
    </div>
    <div class="shapes">
